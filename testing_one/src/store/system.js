...
export const PASSWORDS = {
  investigacion_privada: 'Luna14',  // Nivel 1 → Luna (mascota) + 14 (fecha del caso)
  correo:                'Luna',    // Correo → solo nombre de mascota
};
...
export const useSystem = defineStore('system', () => {
  ...
  watch(() => flags.value.foundCuentaBackup, (v) => {
    if (!v) return;
